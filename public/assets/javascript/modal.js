$(document).ready( function () {
    ...
    //user logic below
    //localStorage.clear();  //for testing pupose only
    var socket;
    var usrnm;
    ...
    (function() {
      ...
      if(localStorage.getItem("user")) {
        ...
        console.log('no storage user data');
      }
    })();
            ...
            $.post('/register', formData, function(res) {
                ...
                if(res.registerErr) {
                    ...
                    for(var i=0; i<res.registerErr.length; i++) {
                        var errLi = $("<li class='alert alert-danger'>" + res.registerErr[i] + "</li>");
                        errUl.append(errLi);
                    }
                    // $('#signup').modal('open');
                }
                    ...
                    console.log("The registered user is " + res.registeredUser);
                    console.log(window.location.href);
    ...
    $('#loginForm').submit(function(event) {
        ...
        // var formData = {  //for testing purpose
        //     'username': 'lauraZ',
        //     'password': '12345678'
        // };
